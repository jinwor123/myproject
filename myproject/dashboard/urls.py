...
urlpatterns = [
    ...
    path("product/<int:pk>/restore/", views.restore_product, name="dashboard-restore-product"), 
    ...
    path('category/<int:pk>/restore/', views.restore_category, name='restore-category'),
    path('category/<int:pk>/edit/', views.edit_category, name='dashboard-edit-category'),
    path('product/unit/', views.add_unit, name='dashboard-unit'),
    path('unit/<int:pk>/delete/', views.delete_unit, name='delete-unit'),
    path('unit/<int:pk>/restore/', views.restore_unit, name='restore-unit'),
    path('unit/<int:pk>/edit/', views.edit_unit, name='dashboard-edit-unit'),
