...
urlpatterns = [
    ...
    path('product/<int:pk>/edit/', views.edit_product, name='dashboard-edit-product'),  # ✅ เพิ่ม
    path('product/<int:pk>/delete/', views.delete_product, name='dashboard-delete-product'),  # ✅ เพิ่ม
